...
exports.booksByTestament = booksByTestament;
exports.booksByCategory = booksByCategory;
exports.BIBLE_BOOKS = [
    // ── OLD TESTAMENT ────────────────────────────────────────────────────────
...
function findBook(query) {
    ...
    return exports.BIBLE_BOOKS.find(b => b.id === q || b.abbr.toLowerCase() === q ||
        b.name.toLowerCase() === q || b.name.toLowerCase().startsWith(q));
}
function booksByTestament() {
    return {
        old: exports.BIBLE_BOOKS.filter(b => b.testament === 'old'),
        new: exports.BIBLE_BOOKS.filter(b => b.testament === 'new'),
        deutero: exports.BIBLE_BOOKS.filter(b => b.testament === 'deuterocanonical'),
    };
}
function booksByCategory() {
    const map = new Map();
    for (const b of exports.BIBLE_BOOKS) {
